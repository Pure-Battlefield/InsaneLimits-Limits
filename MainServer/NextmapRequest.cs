...
announcementServerName2[0] = "PURE BATTLEFIELD: Defaults | $25 TS giveaway Sat";
announcementText[0].Add( "Next map: %m %s" );
announcementText[0].Add( "(It may be different if the server population changes" );
announcementText[0].Add( "enough to activate a different map rotation.)" );
...
announcementServerName1[1] = "";
announcementServerName2[1] = "";
announcementText[1].Add( "Next map: %m %s" );
announcementText[1].Add( "(It may be different if the server population changes" );
announcementText[1].Add( "enough to activate a different map rotation.)" );
...
announcementMaxPlayers[2] = 64;
announcementServerNameMatchRequired[2] = true;
announcementServerName1[2] = "PURE BATTLEFIELD 1: Rush/Conquest | Friendly | Teamspeak";
announcementServerName2[2] = "PURE BATTLEFIELD: Defaults | $25 TS giveaway Sat!";
announcementText[2].Add( "Next map: %m %s" );
announcementText[2].Add( "(It may be different if the server population changes" );
announcementText[2].Add( "enough to activate a different map rotation.)" );
...
announcementServerName1[3] = "";
announcementServerName2[3] = "";
announcementText[3].Add( "Next map: %m %s" );
announcementText[3].Add( "(It may be different if the server population changes" );
announcementText[3].Add( "enough to activate a different map rotation.)" );
...
announcementServerName1[4] = "";
announcementServerName2[4] = "";
announcementText[4].Add( "Next map: %m %s" );
